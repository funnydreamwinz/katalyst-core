...
func (ha *HeadroomAssemblerCommon) getReclaimNUMABindingTopo() (bindingNUMAs, nonBindingNumas []int, err error) {
	...
	for _, node := range ha.metaServer.MachineInfo.Topology {
		numaMap[node.Id] = false
	}
